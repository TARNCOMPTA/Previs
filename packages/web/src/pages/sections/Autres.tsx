...
import { AvecDossier, BlocGrille, EnTeteSection, type ContexteSection } from './commun.js';
 ...
 *
 * Voir « AvecDossier » : c'est ce qui rend les colonnes stabilisables, donc les lignes de
 * grille mémoïsables. L'onglet courant et le logo, qui ne font pas partie du contenu
 * versionné, descendent ici avec le reste.
 */
function CorpsAutres({ dossier, resultats, annees, modifier, modifierLigne, ajouterLigne, supprimerLigne }: ContexteSection) {
...
export default function Autres() {
  return <AvecDossier corps={CorpsAutres} />;
}
